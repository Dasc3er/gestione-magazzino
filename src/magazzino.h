...
/**
 * Funzione per gestire la visualizzazione tabellare del magazzino.
 * 
...
/**
 * Funzione per gestire la modifica di un articolo esistente nel magazzino.
 * Attenzione: modificare la quantità di un articolo attraverso questa operazione non modifica lo storico del magazzino.
 * 
 * @param csv_magazzino Puntatore allo struct per il magazzino CSV
 * @param csv_storico Puntatore allo struct per lo storico CSV
 */
...
/**
 * Funzione per gestire la rimozione di un articolo esistente dal magazzino.
 * Attenzione: questa operazione non rimuove lo storico del magazzino relativo all'articolo rimosso.
 * 
 * @param csv_magazzino Puntatore allo struct per il magazzino CSV
 * @param csv_storico Puntatore allo struct per lo storico CSV
 */
...
/**
 * Funzione per la ricerca (lineare) di un articolo nel magazzino sulla base del relativo codice. La funzione richiede in input un codice all'utente, e restituisce un puntatore al primo articolo del magazzino con il codice indicato.
 * 
 * @param csv_magazzino Puntatore allo struct per il magazzino CSV
 * @param csv_storico Puntatore allo struct per lo storico CSV
 * 
...
/**
 * Funzione per la richiesta dell'input riguardo le caratteristiche di un articolo. La funzione sovrascrive i contenuti della riga indicata come parametro, liberando la memoria allocata per i singoli campi modificati.
 * 
...
/**
 * Funzione per la gestione dell'input per un singolo campo di un articolo.
